        ...
        return (
            <div>
                ...
                <div className='header-icon-container'>
                    ...
                    <div className='header-create-set-container' onClick={ () => this.closeMenu() }>
                ...
                <div className='tablet-header-user-image'>
                    <img className='user-image-medium' src="https://api.adorable.io/avatars/285/abott@adorable.png" alt="profile image"/>
